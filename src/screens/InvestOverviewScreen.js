      ...
      <ScrollView>
        <View>
          <Card containerStyle={styles.card} title="Invest Overview">
            <TextIndent>
              Silicon Prairie Online (SPPX) offers a variety of investment
              opportunities including both debt and equity issues as well as
              grants for non-profit organizations. Our portal is a great place
              for businesses looking to raise capital as well as for investors
              who are looking to earn a good return on their investments. We
              support:
            </TextIndent>
            <TextIndent>
              {
            ...
            <TextIndent>
              {"\u2022 Grants (donations) for qualifying non-profits"}
            </TextIndent>
            <Button
