...
import { Card, CardSection, Header, Input, InputSection } from "@common";
...
class InvestorContainer extends Component {
      ...
      <CardSection>
        ...
        <SubField>
          <View style={styles.row}>
            <Button onPress={() => this.props.takePicture()}>
              Take Picture
            </Button>
  ...
  renderUploadButton() {
    if (
      this.props.investor.stateIDSet === true &&
      this.props.investor.fileUploaded === false
    ) {
    ...
    if (
      ...
      return (
        <View style={{ paddingTop: 10 }}>
          <Button onPress={() => this.props.setStateFid()}>
            Set as State ID
          </Button>
        </View>
      );
      ...
      <View>
        <Card rounded>
          ...
          <CardSection>
            ...
            <SubField>
              <Description>
                If the Ownership is "Joint Tenants" or "Tenants in Common"
                please describe the relationship (e.g. Married, Domestic
                Partners, Investment Club, etc)
              </Description>
            </SubField>
          </CardSection>
              ...
              <View style={styles.accreditedSub}>
                <View style={styles.accreditedSubItem}>
                  <CheckCircle
                    ...
                    onToggle={() =>
                      this.props.toggle2("networth", "accreditation")
                    }
                  />
                  <View style={styles.accreditedItemDetailView}>
                    <Text style={styles.accreditedItemTitle}>Networth</Text>
                    <Text style={styles.descriptionText}>
                      I have a net worth, or a joint net worth together with my
                      spouse, in excess of $1,000,000, excluding the value of my
                      primary residence.
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.accreditedSubItem}>
                  <CheckCircle
                    ...
                    onToggle={() =>
                      this.props.toggle2("income", "accreditation")
                    }
                  />
                  <View style={styles.accreditedItemDetailView}>
                    <Text style={styles.accreditedItemTitle}>Income</Text>
                    <Text style={styles.descriptionText}>
                      I had an individual income in excess of $200,000 in each
                      of the prior two years and reasonably expect an income in
                ...
                <View style={styles.accreditedSubItem}>
                  <CheckCircle
                    ...
                    onToggle={() =>
                      this.props.toggle2("jointIncome", "accreditation")
                    }
                  />
                  <View style={styles.accreditedItemDetailView}>
                    <Text style={styles.accreditedItemTitle}>Joint Income</Text>
                    <Text style={styles.descriptionText}>
                      I had joint income with my spouse in excess of $300,000 in
                      each of the prior two years and reasonably expect joint
...
const SubField = props => <View style={styles.subfield}>{props.children}</View>;
...
const mapStateToProps = state => ({ investor, meta } = state.profile);
