...
import { Card, CardSection, Header, Input } from '../../../components/common';
import { R, connect } from '../../../globals';
...
class IndividualContainer extends Component {
  render() {
    ...
    let isEditable = this.props.meta.isEditable;
...
const mapStateToProps = state => {
  return ({ individual, meta } = state.profile);
};

export default connect(mapStateToProps, { onProfileChange })(IndividualContainer);
